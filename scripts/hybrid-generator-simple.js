...
console.log('🚀 HYBRID GENERATOR - SIMPLE VERSION');
console.log('====================================\n');
...
const generatePage = (pageType) => {
  ...
  const pageDir = path.join(appDir, pageType);
  ...
  console.log(`✅ Generated ${pageType} page: ${pagePath}`);
};
...
const generateAllPages = () => {
  ...
  Object.keys(pageTemplates).forEach(pageType => {
    console.log(`  - app/${pageType}/page.tsx`);
  });
};
...
if (command === 'page' && pageType) {
  generatePage(pageType);
} else if (command === 'all') {
  generateAllPages();
} else {
  console.log('Usage:');
  console.log('  node scripts/hybrid-generator-simple.js page <type>  - Generate specific page');
  console.log('  node scripts/hybrid-generator-simple.js all         - Generate all pages');
  console.log('');
  console.log('Available page types:');
  Object.keys(pageTemplates).forEach(type => {
    console.log(`  - ${type}`);
  });
}
