...
// Complete 50 Categories Data (embedded to avoid import issues)
const ALL_50_CATEGORIES = [
  ...
  // Continue with remaining 48 categories...
  // (I'll generate the remaining categories programmatically)
];

// Generate remaining 48 categories
function generateRemainingCategories() {
  const baseCategories = [
    { id: 'automobile', name: 'Automobile', icon: '🚗', description: 'Auto parts, vehicle components, tires, and automotive accessories' },
