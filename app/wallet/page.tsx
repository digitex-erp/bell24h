    ...
    <div className="page-container">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          {/* Wallet Features */}
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-semibold text-neutral-900 mb-6">Wallet Features</h2>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Shield className="h-5 w-5 text-green-600 mt-1" />
                <div>
                  <h3 className="font-medium text-neutral-900">Secure Transactions</h3>
                  <p className="text-neutral-600 text-sm">Bank-level encryption and fraud protection</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Clock className="h-5 w-5 text-green-600 mt-1" />
                <div>
                  <h3 className="font-medium text-neutral-900">Instant Transfers</h3>
                  <p className="text-neutral-600 text-sm">Real-time money transfers between users</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
                <div>
                  <h3 className="font-medium text-neutral-900">Easy Integration</h3>
                  <p className="text-neutral-600 text-sm">Seamless integration with B2B transactions</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <AlertCircle className="h-5 w-5 text-green-600 mt-1" />
                <div>
                  <h3 className="font-medium text-neutral-900">Transaction Limits</h3>
                  <p className="text-neutral-600 text-sm">Flexible limits based on verification level</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-2xl font-semibold text-neutral-900 mb-6">Recent Transactions</h2>
              ...
              <tbody className="divide-y">
                {transactions.map((transaction) => (
                  <tr key={transaction.id}>
                    ...
                    <td className="py-3 px-4 text-neutral-700">{transaction.description}</td>
        ...
        <div className="text-center">
          <div className="bg-blue-50 rounded-lg p-8">
            <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Ready to Use Digital Wallet?</h2>
