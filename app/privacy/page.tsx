      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>We may use third-party services such as Razorpay for payment processing, and these services have their own privacy policies.</p>
            ...
            <ul>
              <li>Email: privacy@bell24h.com</li>
