      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="page-header">
            ...
            <p className="text-sm text-neutral-600">Last Updated: September 11, 2025</p>
          </div>
          ...
          <div className="prose max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-neutral-900">Submit Request</h3>
                    <p className="text-neutral-600 text-sm">Contact support with transaction details and reason for refund</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="bg-blue-100 rounded-full p-2">
                  ...
                  <div>
                    <h3 className="font-medium text-neutral-900">Review Process</h3>
                    <p className="text-neutral-600 text-sm">Our team reviews the request within 2-3 business days</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-neutral-900">Refund Processing</h3>
                    <p className="text-neutral-600 text-sm">Approved refunds are processed within 5-7 business days</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">3. Refund Timeline</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">4. Non-Refundable Items</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">5. Contact Information</h2>
