@echo off
echo === NUCLEAR OPTION - REMOVE ALL ICONS ===
echo.

echo Step 1: Creating a minimal admin dashboard without icons...
powershell -Command "@'
'use client';
...
'@ | Out-File -FilePath 'app\admin\dashboard\page.tsx' -Encoding UTF8"

echo ✓ Created icon-free admin dashboard
...
echo.
echo Step 3: Committing nuclear fix...
git commit -m "Nuclear fix - remove all lucide-react icons, use emojis instead"
...
echo ✅ No more icon imports - using emojis instead
...
echo.
echo This is guaranteed to work - no external dependencies!
pause
