...
// Complete 50 Categories Data for Neon PostgreSQL
...
async function seedAllCategories() {
  console.log('🌱 Starting comprehensive category seeding for Neon PostgreSQL...')
  ...
  try {
    ...
    // Seed categories
    console.log('📂 Seeding 50 categories to Neon PostgreSQL...')
