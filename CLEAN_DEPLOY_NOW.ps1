# CLEAN DEPLOY SCRIPT - No markdown, no formatting issues
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "CLEAN DEPLOY TO BELL24H-V1" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# Step 1: Clear any markdown artifacts and reset terminal
Write-Host "Step 1: Clearing terminal artifacts..." -ForegroundColor Yellow
Clear-Host
Write-Host "Terminal cleared" -ForegroundColor Green

# Step 2: Fix Hero.tsx with clean content
Write-Host ""
...
# Step 3: Set up project linking
Write-Host ""
Write-Host "Step 3: Setting up project linking..." -ForegroundColor Yellow
