# AUTO DEPLOY EVERYTHING - Complete Bell24h Deployment Solution
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "AUTO DEPLOY EVERYTHING TO BELL24H-V1" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "This script will automatically:" -ForegroundColor Yellow
Write-Host "✅ Fix project linking (bell24h-complete → bell24h-v1)" -ForegroundColor Green
Write-Host "✅ Install Vercel CLI" -ForegroundColor Green
Write-Host "✅ Fix Hero.tsx build errors" -ForegroundColor Green
Write-Host "✅ Store Razorpay live keys" -ForegroundColor Green
Write-Host "✅ Build project with all pages" -ForegroundColor Green
Write-Host "✅ Deploy to bell24h-v1 (ID: prj_8ub3FQx2y1KUEgTZcjrb2Urzt7mS)" -ForegroundColor Green
Write-Host "✅ Verify all pages are live on bell24h.com" -ForegroundColor Green
Write-Host ""
...
try {
    ...
    Write-Host "⚠️ Using npx vercel instead" -ForegroundColor Yellow
}
...
# Step 3: Create manual project link to bell24h-v1
Write-Host ""
...
Write-Host "✅ Project linked to bell24h-v1 (ID: prj_8ub3FQx2y1KUEgTZcjrb2Urzt7mS)" -ForegroundColor Green
...
# Step 5: Store Razorpay live keys
Write-Host ""
Write-Host "Step 5: Setting up Razorpay live keys..." -ForegroundColor Yellow
$envContent = @"
...
try {
    ...
    try {
        vercel --prod
        Write-Host "✅ Deployment successful with global CLI!" -ForegroundColor Green
    } catch {
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "🎉 Your Bell24h website is now live with:" -ForegroundColor Green
...
Write-Host "  ✅ Correct project deployment (bell24h-v1)" -ForegroundColor White
Write-Host ""
