...
// 🔗 GITHUB ULTRA MCP SERVER - SIMPLIFIED VERSION
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.log('node mcp-github-ultra-simple.js page <type>');
    console.log('node mcp-github-ultra-simple.js multiple <type1> <type2> ...');
