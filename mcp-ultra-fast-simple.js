...
// ⚡ ULTRA-FAST MCP SERVER - SIMPLIFIED VERSION
// Generates pages in milliseconds with pre-loaded templates
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.log('node mcp-ultra-fast-simple.js page <type>');
    console.log('node mcp-ultra-fast-simple.js multiple <type1> <type2> ...');
    console.log('node mcp-ultra-fast-simple.js all');
