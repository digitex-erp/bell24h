...
export function useWebSocket(options: UseWebSocketOptions) {
  ...
  }, [config.url, config.protocols, config.onOpen, config.onClose, config.onError, config.onMessage, config.onBatchMessage, config.batchProcessing]);
  ...
  const attemptReconnect = useCallback(() => {
    ...
    const backoffTime = config.reconnectInterval! * Math.pow(
  ...
  }, [connect, config.reconnectAttempts, config.reconnectInterval, config.reconnectBackoffMultiplier]);
