      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent className="p-4">
                <div className="space-y-2">
                  ...
                  <Link href="/financial-services">
                    <button className="w-full text-left px-4 py-2 hover:bg-gray-50 rounded-md flex items-center text-gray-700">
                      <i className="fas fa-university mr-3 text-primary-600"></i>
          ...
          <div className="lg:col-span-2">
            ...
            {/* New Financial Services Promo Card */}
            <Card className="mt-6">
              <CardHeader className="bg-gradient-to-r from-blue-700 to-indigo-900 text-white">
                <h2 className="text-xl font-semibold flex items-center">
                  <i className="fas fa-university mr-3"></i>
                  New Financial Services Available
                </h2>
              </CardHeader>
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="border rounded-lg p-4 bg-gray-50 hover:bg-gray-100 transition-colors">
                    <div className="flex items-start">
                      <div className="bg-primary-100 p-3 rounded-full mr-4">
                        <i className="fas fa-file-invoice-dollar text-xl text-primary-600"></i>
                      </div>
                      <div>
                        <h3 className="font-medium text-gray-900">KredX Invoice Financing</h3>
                        <p className="text-sm text-gray-600 mt-1">Convert unpaid invoices into immediate cash</p>
                        <p className="text-xs text-gray-500 mt-1">Rates from 0.5-2%</p>
                      </div>
                    </div>
                    <Link href="/financial-services?tab=kredx">
                  ...
                  <div className="border rounded-lg p-4 bg-gray-50 hover:bg-gray-100 transition-colors">
                    <div className="flex items-start">
                      <div className="bg-primary-100 p-3 rounded-full mr-4">
                        <i className="fas fa-tasks text-xl text-primary-600"></i>
                      </div>
                      <div>
                        <h3 className="font-medium text-gray-900">M1 Exchange Early Payments</h3>
                        <p className="text-sm text-gray-600 mt-1">Get paid as soon as milestones are approved</p>
                        <p className="text-xs text-gray-500 mt-1">Rates from 1-2%</p>
                      </div>
                    </div>
                    <Link href="/financial-services?tab=m1exchange">
                      <Button variant="outline" size="sm" className="w-full mt-3">
                        Learn More
                      </Button>
                    </Link>
