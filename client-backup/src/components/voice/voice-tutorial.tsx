...
export function VoiceTutorial({
  ...
  return (
    <DialogWrapper>
      <DialogHeader>
        <DialogTitle className="text-2xl">{t('voiceTutorial.title', 'Voice-Based RFQ Tutorial')}</DialogTitle>
        <DialogDescription>
          {t('voiceTutorial.description', 'Learn how to effectively use voice features for RFQ submission and analysis.')}
        </DialogDescription>
      </DialogHeader>
      
      <Tabs defaultValue="overview" value={currentTab} onValueChange={handleTabChange}>
        <TabsList className="grid grid-cols-4 mb-4">
          <TabsTrigger value="overview">{t('voiceTutorial.tabs.overview', 'Overview')}</TabsTrigger>
          <TabsTrigger value="submission">{t('voiceTutorial.tabs.submission', 'Voice Submission')}</TabsTrigger>
          <TabsTrigger value="languages">{t('voiceTutorial.tabs.languages', 'Language Support')}</TabsTrigger>
          <TabsTrigger value="analytics">{t('voiceTutorial.tabs.analytics', 'Voice Analytics')}</TabsTrigger>
        </TabsList>
