...
describe('useBlockchain', () => {
  ...
  it('should handle transaction creation error', async () => {
    mockBlockchainService.createTransaction.mockRejectedValueOnce(
  ...
  it('should handle fund release error', async () => {
    mockBlockchainService.releaseFunds.mockRejectedValueOnce(
  ...
  it('should handle refund error', async () => {
    mockBlockchainService.refund.mockRejectedValueOnce(
  ...
  it('should handle dispute raising error', async () => {
    mockBlockchainService.raiseDispute.mockRejectedValueOnce(
  ...
  it('should handle dispute resolution error', async () => {
    mockBlockchainService.resolveDispute.mockRejectedValueOnce(
  ...
  it('should handle transaction events', async () => {
    ...
    expect(mockBlockchainService.onTransactionCreated).toHaveBeenCalledWith(
      onTransactionCreated
    );
    expect(mockBlockchainService.onFundsReleased).toHaveBeenCalledWith(
      onFundsReleased
    );
    expect(mockBlockchainService.onDisputeRaised).toHaveBeenCalledWith(
      onDisputeRaised
    );
    expect(mockBlockchainService.onDisputeResolved).toHaveBeenCalledWith(
      onDisputeResolved
    );
  });
