...
import { sendNotification, storeNotification, NotificationType } from '../utils/notificationService';
    ...
    mockSocket.on('notification', (data) => {
      ...
      switch (data.type) {
        ...
        case 'bid-status':
          ...
          break;
        case 'trend-update':
          notificationType = NotificationType.TREND_UPDATE;
          break;
        case 'payment':
          notificationType = NotificationType.PAYMENT;
          break;
        case 'shipping':
          notificationType = NotificationType.SHIPPING;
          break;
        default:
      ...
      const notification = sendNotification(notificationType, data.message || 'New notification');
